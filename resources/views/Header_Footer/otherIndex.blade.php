        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li>
                        <a href="/restaurant"><strong>Restaurants</strong></a>
                    </li>
                    ...
                    <li class="dropdown" id="dicision-body">
                        @yield('dicision-body')
                    </li>
...
<div class="container" id="details-panel" style="border: 2px solid whitesmoke;margin-bottom: 20px;padding-top: 20px">
