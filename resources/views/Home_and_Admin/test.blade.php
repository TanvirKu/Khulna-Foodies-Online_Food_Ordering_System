...
<div class="page-header" id="Buffo">
    ...
    <div class="col-sm-12">
        <div class="jumbotron" style="color:black">
            <div class="row">
                <div class="col-sm-6">
                        <img src="{!! asset('images/FoodNetwork.jpg') !!}" height="300px;">
                </div>
                <div class="col-sm-6">
                    <h3>Hi! Welcome in Khulna Foodies :)</h3>
                    <p><h4>Our's is a website that provides numerous
                     information about foods in khulna.Here advertisement 
                     of foods are also available. We have divided the city 
                     into different zones. And food items can be searched
                      zone wise . So Visit Khulna Foodies , Come On !!
                      <strong><h2>EAT ! RATE ! SHOUT !</h2></strong>
                  </h4></p>
                </div>
            </div>
         </div>
